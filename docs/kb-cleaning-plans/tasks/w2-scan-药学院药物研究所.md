# 任务：扫描 W2 药学院（药物研究所）页面

## 工作目录
`C:\Users\Administrator\Documents\code\kb-pipeline\ws2-website-scrape\scraped-pages\药学院（药物研究所）`

## 任务概述
扫描药学院（药物研究所）目录下的所有 .md 文件（共 49 个），按照知识库入库标准进行筛选和分类，产出结构化扫描报告。

## 输入
- 待扫描目录：`C:\Users\Administrator\Documents\code\kb-pipeline\ws2-website-scrape\scraped-pages\药学院（药物研究所）`
...
## 输出
将完整的扫描报告写入：
`C:\Users\Administrator\Documents\code\kb-pipeline\ws2-website-scrape\kimi-reports\scan-药学院药物研究所.md`
