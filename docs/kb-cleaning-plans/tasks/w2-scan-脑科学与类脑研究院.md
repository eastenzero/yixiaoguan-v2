# 任务：扫描 W2 脑科学与类脑研究院页面

## 工作目录
`C:\Users\Administrator\Documents\code\kb-pipeline\ws2-website-scrape\scraped-pages\脑科学与类脑研究院`

## 任务概述
扫描脑科学与类脑研究院目录下的所有 .md 文件（共 49 个），按照知识库入库标准进行筛选和分类，产出结构化扫描报告。

## 输入
- 待扫描目录：`C:\Users\Administrator\Documents\code\kb-pipeline\ws2-website-scrape\scraped-pages\脑科学与类脑研究院`
...
## 输出
将完整的扫描报告写入：
`C:\Users\Administrator\Documents\code\kb-pipeline\ws2-website-scrape\kimi-reports\scan-脑科学与类脑研究院.md`
