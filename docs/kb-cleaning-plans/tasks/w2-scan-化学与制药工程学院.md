# 任务：扫描 W2 化学与制药工程学院页面

## 工作目录
`C:\Users\Administrator\Documents\code\kb-pipeline\ws2-website-scrape\scraped-pages\化学与制药工程学院`

## 任务概述
扫描化学与制药工程学院目录下的所有 .md 文件（共 50 个），按照知识库入库标准进行筛选和分类，产出结构化扫描报告。

## 输入
- 待扫描目录：`C:\Users\Administrator\Documents\code\kb-pipeline\ws2-website-scrape\scraped-pages\化学与制药工程学院`
...
## 输出
将完整的扫描报告写入：
`C:\Users\Administrator\Documents\code\kb-pipeline\ws2-website-scrape\kimi-reports\scan-化学与制药工程学院.md`
