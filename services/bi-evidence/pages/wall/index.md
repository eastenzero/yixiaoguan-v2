...
<div class="wall-masthead">
  <div class="wall-mast-left">
    <div class="wall-eyebrow">PILOT · VOL.I · 山一医</div>
    <h1 class="wall-title">医小管 · 内测大屏</h1>
  </div>
  <div class="wall-mast-right">
    <div class="wall-day">启动第<span class="num">{dayNum}</span>天</div>
    <div class="wall-clock">
      <span class="wall-clock-time">{mounted ? clockTime : '--:--:--'}</span>
      <span class="wall-clock-date">{mounted ? clockDate : '----'}</span>
    </div>
...
<div class="wall-section">
  <span class="wall-section-mark">§ 一</span>
  <h2 class="wall-section-title">即时态势</h2>
  <span class="wall-section-en">Real-time KPI</span>
</div>
...
<!-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ -->
<div class="wall-section">
  <span class="wall-section-mark">§ 二</span>
  <h2 class="wall-section-title">学生路径</h2>
  <span class="wall-section-en">User Funnel & Daily Trend</span>
</div>
...
<div class="wall-charts">
  ...
  <div class="wall-card">
    ...
    <h3 class="wall-card-title">从启动 App 到留下反馈</h3>
    <div class="wall-funnel">
      {#each funnel as row}
  ...
  <div class="wall-card">
    ...
    <h3 class="wall-card-title">日级提问 · AI 已答 · 活跃</h3>
    <LineChart
      data={daily}
      x=day
      y={['提问', 'AI已答', '活跃用户']}
      ...
      chartAreaHeight=240
      labelSize=11
      colorPalette={['#5B1F5B', '#A23130', '#A98B4F']}
    />
  </div>
</div>
...
<div class="wall-ticker">
  <div class="wall-ticker-label">印刷推送</div>
...
<!-- 页脚 -->
<div class="wall-foot">
  <div>医小管编辑部 · {now.getFullYear()}</div>
  <div class="wall-foot-stamp">每 5 分钟自动刷新</div>
</div>
