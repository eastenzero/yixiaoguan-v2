<template>
  <view :class="['app-icon', iconClass]" aria-hidden="true">
    <view class="icon-part p1"></view>
    <view class="icon-part p2"></view>
    <view class="icon-part p3"></view>
    <view class="icon-part p4"></view>
  </view>
</template>
...
const aliases: Record<string, string> = {
  ...
  person_off: 'person',
  priority_high: 'info',
  progress_activity: 'hourglass',
  psychology: 'bot',
  task_alt: 'check',
  trending_down: 'arrow_forward',
  trending_up: 'arrow_forward',
  volume_up: 'megaphone',
  ...
  lock: 'lock',
  logout: 'logout',
  mark_chat_read: 'chat-check',
  menu_book: 'book',
  message: 'chat',
  notifications: 'bell',
  open_in_full: 'corners-out',
...
const iconClass = computed(() => {
  ...
  return `icon-${supported.has(icon) ? icon : 'info'}`
})
</script>
...
.icon-person .p1,
.icon-groups .p1,
.icon-face_retouching_natural .p1 {
  display: block;
  width: 0.34em;
  height: 0.34em;
  left: 0.33em;
...
.icon-person .p2,
.icon-groups .p2,
.icon-face_retouching_natural .p2 {
  display: block;
  width: 0.70em;
  height: 0.36em;
  left: 0.15em;
  bottom: 0.10em;
  border: 0.12em solid currentColor;
  border-radius: 0.38em 0.38em 0.16em 0.16em;
...
.icon-bell .p1 {
  ...
  border: 0.12em solid currentColor;
  border-bottom: 0;
  border-radius: 0.36em 0.36em 0.14em 0.14em;
}
...
.icon-arrow_forward .p1,
.icon-arrow_back .p1,
.icon-chevron-right .p1,
.icon-external .p3,
.icon-corners-out .p1,
.icon-corners-in .p1,
.icon-logout .p1 {
...
.icon-send .p1 {
  ...
  border-left: 0.76em solid currentColor;
}
...
.icon-meeting_room .p1 {
  ...
  top: 0.11em;
  border: 0.11em solid currentColor;
  border-radius: 0.20em 0.20em 0.06em 0.06em;
}

.icon-gate .p2,
.icon-meeting_room .p2 {
  display: block;
  width: 0.12em;
  height: 0.12em;
  right: 0.30em;
