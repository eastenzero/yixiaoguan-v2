<template>
  <view v-if="visible" class="sheet-overlay" @click="close">
    <view class="sheet-panel" @click.stop>
      ...
      <text class="sheet-desc">{{ description }}</text>

      <view class="sheet-actions">
        <view class="btn-secondary" @click="close">
          <text class="btn-secondary-text">我知道了</text>
        </view>
      </view>
    </view>
  </view>
